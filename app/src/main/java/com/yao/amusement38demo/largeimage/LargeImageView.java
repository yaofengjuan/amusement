 ...
 */
package com.yao.amusement38demo.largeimage;
...
import com.yao.amusement38demo.largeimage.ImageManager.OnImageLoadListenner;
...
//		canvas.clipRect(visiableRect);
		...
		List<ImageManager.DrawData> drawData = imageManager.getDrawData(imageScale, imageRect);

		Log.d("countTime", "getDrawData " + (SystemClock.uptimeMillis() - startTime));
		startTime = SystemClock.uptimeMillis();

		for (ImageManager.DrawData data : drawData) {
